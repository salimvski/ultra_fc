<template>
    <div class="bg-white h-screen overflow-hidden">
      <div class="absolute inset-0 h-full w-full brightness-50">
          <img :src="ultrafc_premiership_win" alt="Ultra FC Premiership Win" class="h-full w-full object-cover"  />
      </div>
          ...
          <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a
                ...
                >Accueil</a
              >
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hidden"
